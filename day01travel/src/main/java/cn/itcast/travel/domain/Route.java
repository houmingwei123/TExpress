...
public class Route implements Serializable {
    ...
    public String toString() {
        ...
        sb.append(", routeIntroduce='").append(routeIntroduce).append('\'');
        sb.append(", rflag='").append(rflag).append('\'');
        sb.append(", rdate='").append(rdate).append('\'');
        sb.append(", isThemeTour='").append(isThemeTour).append('\'');
        sb.append(", count=").append(count);
        sb.append(", cid=").append(cid);
        sb.append(", rimage='").append(rimage).append('\'');
        sb.append(", sid=").append(sid);
        sb.append(", sourceId='").append(sourceId).append('\'');
        sb.append(", category=").append(category);
        sb.append(", seller=").append(seller);
        sb.append(", routeImgList=").append(routeImgList);
        sb.append('}');
        return sb.toString();
    }
}
